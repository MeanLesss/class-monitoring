...
# Serialize YOLO calls (streamlit may rerun from multiple threads).
_INFER_LOCK = __import__("threading").Lock()
...
if _live_photo is not None:
    ...
    if _img is not None:
        st.image(_live_photo, caption="Captured photo", use_container_width=True)
